...
.alink:hover, .alink:active{
 ...
 height:70px;
   ...
   <h1 style="margin-left:500px;font-size:23px;font-family:cursive;">Komponente </h1> <br> </hr>
    <div class="py-12 sm:rounded-lg" style="background-color:lightgreen;width:700px;margin-left:200px;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
                    ...
                    <div  class="shadow-xl  sm:rounded-lg" style="width: 400px;align:center;background-color:white;margin-left:100px;">
                    ...
                    <td style="font-family:cursive">Komponenta {{$proz->ime}} </td>
</tr>
                    
<tr>
                    <td style="font-weight:bold;" >Cijena:</td>
                    <td>{{$proz->cijena}} KM </td>
</tr>

<tr>
    
                    <td style="font-weight:bold;">Stanje:</td>
                    <td>{{$proz->stanje}}</td>
