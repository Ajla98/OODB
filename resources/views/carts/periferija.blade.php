...
.alink:hover, .alink:active{
 ...
 height:70px;
   ...
   <h1 style="margin-left:500px;font-size:23px;font-family:cursive;">Periferija </h1> <br> </hr>
    <div class="py-12 sm:rounded-lg" style="background-color:#FFE87C;width:700px;margin-left:200px;">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
                    ...
                    <td style="font-family:cursive">{{$proz->ime}} </td>
</tr>
